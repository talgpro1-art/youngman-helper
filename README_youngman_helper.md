...
렌터카 영업매니저가 모바일에서 국내 판매 TOP50 차량의 순위, 공식 가격표/PDF, 관심 옵션, 신차/가격표 이슈를 빠르게 확인하는 Streamlit 대시보드입니다.
...
- 주요 화면: TOP50 / 가격표 / 옵션
- 데이터: TOP50 차량 및 공식 가격표 URL 1차 수집본 기반
...
영맨 헬퍼는 국내 판매 TOP50 차량의 판매순위, 공식 가격표, 주요 옵션 설명, 신차/가격표 변경 이슈를 모바일에서 한 번에 확인하는 렌터카 영업지원 대시보드입니다. 영업매니저가 차량별 가격표와 옵션 설명, 신차 뉴스를 각각 검색하던 시간을 줄이고, 고객 상담 전 필요한 정보를 빠르게 확인하도록 돕습니다.
